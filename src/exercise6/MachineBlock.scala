...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
object RunMachineBlock extends App:
    new MachineBlockModel()
end RunMachineBlock


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MachineBlockModel` class defines a process-interaction model of a simple
 ...
 */
class MachineBlockModel (name: String = "Machine", reps: Int = 1, animating: Boolean = true,
    ...
    case class Part () extends SimActor ("p", this):
        ...
        def act (): Unit =
            // 1. go to M1 queue
            // 2. if M1 queue full then go to scrap else wait in queue
            // 3. if M2 queue full then do not go
            // 4.
            toMachine1Q.move ()
            ...
            machine1.utilize ()
            if machine2Q.length < 3 then
                println("length is " + machine2Q.length)
                machine1.release()
                toMachine2Q.move()
                if machine2Q.length == 0 then machine2Q.noWait()
            else println("machine 1 is blocked")
            end if
            //stay at machine1, don't allow machine1 queue to go into machine1 until this entity leaves
